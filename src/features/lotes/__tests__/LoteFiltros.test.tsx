...
function criarPropriedades(
  ...
  return {
    ...
    onMudarCodigoCadastro: vi.fn((_value: string): void => {}),
    onMudarNome: vi.fn((_value: string): void => {}),
    onMudarStatus: vi.fn((_value: Propriedades["status"]): void => {}),
    onMudarEmpresa: vi.fn((_value: string): void => {}),
    onMudarDiretoriasRegionais: vi.fn((_values: string[]): void => {}),
    onMudarPeriodoInicial: vi.fn((_value: string): void => {}),
    onMudarPeriodoFinal: vi.fn((_value: string): void => {}),
    onBuscar: vi.fn((): void => {}),
    onLimpar: vi.fn((): void => {}),
    ...sobrescritas,
  };
